...
while [[ $SECONDS != $1 ]]; do
    ...
    <ul style="font-size:0.95em;">
      <li>Anstatt den Prozessor ruhen zu lassen, nutzt dieser Code eine Dauerschleife, die den Kern zu 100 % auslastet, während er eigentlich nur warten soll.</li>
      <li>Da das Skript starr auf eine exakte Sekunde prüft, führt jede Verzögerung dazu, dass es den Moment verpasst und danach endlos weiterläuft.</li>
      <li>GitHub grillt durch dilettantischen Code die Hardware seiner Nutzer – und verlangt ab 2026 Gebühren für genau diese verschwendete Rechenzeit.</li>
    </ul>
  </div>
</details>
