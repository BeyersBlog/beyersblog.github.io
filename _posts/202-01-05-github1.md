...
while [[ $SECONDS != $1 ]]; do
    ...
    <ul style="font-size:0.95em;">
      ...
      <li>Da Bash die Variable SECONDS nur in groben Zeitschritten aktualisiert, kann der Zielwert leicht übersprungen werden. In diesem Fall wird die Abbruchbedingung niemals erreicht - die Schleife läuft endlos weiter.</li>
